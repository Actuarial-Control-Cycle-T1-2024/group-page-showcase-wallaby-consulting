...
<img src="Logos.png" width="250" alt="logo image">
...
3. [Program Design](#3-program-design)
  - 3.1. [Evercare: Your Wellness Journey](#31-evercare-your-wellness-journey)
  - 3.2. [Engagement Strategy](#32-engagement-strategy)
  - 3.3. [Timeline of Implementation](#33-timeline-of-implementation)
4. [Pricing and Costs](#4-pricing-and-costs)
 - 4.1. [Mortality Analysis](#41-mortality-analysis)
 - 4.2 [Premium Pricing Methodology](#42-premium-pricing-methodology)
 - 4.3. [Profitability Analysis](#43-profitability-analysis)
 - 4.4. [Program Implementation Timeline](#44-sensitivity-analysis-and-program-impact)
5. [Risk & Risk Mitigation Strategies](#5-risk--risk-mitigation-strategies)
6. [Assumptions & Data Limitations ](#6-assumptions--data-limitations)
...
| Risk Category | Description | Risk Mitigation Techniques | 
| ------------- | ----------- | -------------------------- |
| Insurance – Pricing Risk | (Quantitative)	The risk that the assumptions and data Wallaby Consulting based our models on, when pricing these products, were incorrect. | Sensitivity testing has been undertaken, considering a wide range of historical (if historical data existed) and predicted scenarios.  
...
| Insurance – Catastrophe Risk | (Qualitative)	The risk that a catastrophic event, such as a pandemic or large-scale natural disaster, impacting health and mortality, will occur.	| SuperLife to receive legal advice on the recommended exclusions in the policy terms and conditions, for the EverCare program.  
...
The key data limitations and subsequent assumptions made for the modelling and pricing of EverCare, are summarised below.
